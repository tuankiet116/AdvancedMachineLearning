# https://opencv2-tutorial.readthedocs.io/en/latest/yolo/yolo.html
# https://docs.opencv2.org/master/d6/d0f/group__dnn.html
# https://docs.opencv2.org/3.4/db/d30/classcv2_1_1dnn_1_1Net.html
# https://github.com/opencv2/opencv2/blob/master/samples/dnn/object_detection.py
import cv2 as cv2
import numpy as np
import time
...
def postprocess(frame, outs):
    ...
    for i in indices:
        ...
        if k%256 == 32:
            # SPACE pressed
            img_name = "qr_code_{}.png".format(img_counter)
